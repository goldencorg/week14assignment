...
{/* imported playlist image for selected playlist,
    uses prop to demonstrate the title of selected playlist,
    setup up title with button next to image */}
            ...
            <div className="d-flex flex-row">
                ...
                <div className='align-self-center' style={{paddingLeft: '5vw', overflow: 'hidden'}}>
                    ...
                    <div className='d-flex flex-wrap'>
                        ...
                        <div style={{paddingBottom:5, paddingRight:5}}>
                            <button style={{width:100}} className='btn btn-lg btn-dark' type='button'>Add</button>
                        </div>
                    </div>
                </div>
            </div>
